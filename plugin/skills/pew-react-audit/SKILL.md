...
1. Write your complete output to your designated file under `{config.paths.audit_react}/`.
2. Do not write to any other agent's file.
3. Signal completion with: `[react-audit-<name>] COMPLETE ✓ -- saved to {config.paths.audit_react}/<filename>`
