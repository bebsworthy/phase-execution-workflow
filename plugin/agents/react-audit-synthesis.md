...
Read all files in `{config.paths.audit_react}/`:
...
Write `{config.paths.audit_react}/07-synthesis.md` with:
...
Signal completion: `[react-audit-synthesis] COMPLETE ✓ -- saved to {config.paths.audit_react}/07-synthesis.md`
