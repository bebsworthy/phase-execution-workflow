...
Read files in `{config.paths.audit_react}/`:
...
Write `{config.paths.audit_react}/08-roadmap.md` with all 5 sections above.

Signal completion: `[react-audit-roadmap] COMPLETE ✓ -- saved to {config.paths.audit_react}/08-roadmap.md`
