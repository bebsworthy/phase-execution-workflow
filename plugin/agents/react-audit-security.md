...
Write `{config.paths.audit_react}/03-security.md` using the finding report format from the react-audit skill.
...
Signal completion: `[react-audit-security] COMPLETE ✓ -- saved to {config.paths.audit_react}/03-security.md`
