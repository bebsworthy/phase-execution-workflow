...
Write `{output_dir}/04-framework.md` using the finding report format. Include total count of "zero-value tests" and estimated percentage of the test suite they represent.
...
Signal completion: `[test-audit-framework] COMPLETE ✓ — saved to {output_dir}/04-framework.md`
