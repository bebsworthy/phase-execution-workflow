...
Write `{output_dir}/02-tautological.md` using the finding report format from the test-audit skill. Group by severity.

Signal completion: `[test-audit-tautological] COMPLETE ✓ — saved to {output_dir}/02-tautological.md`
