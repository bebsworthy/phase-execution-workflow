...
Read `{output_dir}/01-inventory.json` for the test file inventory and health check results, then read the source and test files.
...
Write `{output_dir}/07-flaky.md` with a flakiness risk report:
...
Signal completion: `[test-audit-flaky] COMPLETE ✓ — saved to {output_dir}/07-flaky.md`
