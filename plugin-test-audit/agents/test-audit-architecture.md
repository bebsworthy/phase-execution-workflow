...
Read all files in `{output_dir}/` (01 through 09), plus the project's source and test structure.
...
Write `{output_dir}/10-architecture.md` with:
1. Proposed directory structure diagram with migration instructions
2. Complete testing playbook (all 7 sections)

Signal completion: `[test-audit-architecture] COMPLETE ✓ — saved to {output_dir}/10-architecture.md`
