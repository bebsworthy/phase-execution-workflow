...
Write `{output_dir}/06-maintainability.md` with a maintainability scorecard per test file:
...
Signal completion: `[test-audit-maintainability] COMPLETE ✓ — saved to {output_dir}/06-maintainability.md`
