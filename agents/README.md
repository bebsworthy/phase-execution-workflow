...
| ----------------------------------------------- | ------- | ------------------------------------------------------------------------ | ----------------------------------------------------- | ----------------------------------------------------------- |
| [test-audit-inventory](test-audit-inventory.md) | inherit | Phase 1: stack detection, test inventory, health check                   | Source + test directories                             | `test-review/01-inventory.json`                             |
| [test-audit-tautological](test-audit-tautological.md) | inherit | Phase 2: tautological & implementation-mirroring tests (parallel)   | Inventory + source/test files                         | `test-review/02-tautological.md`                            |
| [test-audit-mocking](test-audit-mocking.md)     | inherit | Phase 2: over-mocking & mock misuse (parallel)                           | Inventory + source/test files                         | `test-review/03-mocking.md`                                 |
| [test-audit-framework](test-audit-framework.md) | inherit | Phase 2: framework/trivial/assertion-free tests (parallel)               | Inventory + source/test files                         | `test-review/04-framework.md`                               |
| [test-audit-coverage](test-audit-coverage.md)   | inherit | Phase 2: missing coverage & happy-path bias (parallel)                   | Inventory + source/test files                         | `test-review/05-coverage.md`                                |
| [test-audit-maintainability](test-audit-maintainability.md) | inherit | Phase 2: structural quality & maintainability (parallel)       | Inventory + source/test files                         | `test-review/06-maintainability.md`                         |
| [test-audit-flaky](test-audit-flaky.md)         | inherit | Phase 2: flaky tests & CI reliability (parallel)                         | Inventory + source/test files                         | `test-review/07-flaky.md`                                   |
| [test-audit-synthesis](test-audit-synthesis.md) | inherit | Phase 3: consolidate findings, prioritize remediation                    | All Phase 1-2 outputs                                 | `test-review/08-synthesis.md`                               |
| [test-audit-remediation](test-audit-remediation.md) | inherit | Phase 4: concrete code fixes with before/after                       | Synthesis + source/test files                         | `test-review/09-remediation.md`                             |
| [test-audit-architecture](test-audit-architecture.md) | inherit | Phase 5: test architecture redesign & playbook                     | All previous outputs                                  | `test-review/10-architecture.md`                            |
