...
| [traceability-auditor](traceability-auditor.md) | inherit | Traceability verification between artifacts                              | Two artifact files + expected ID patterns             | Coverage report (covered/missing/orphaned)                  |
